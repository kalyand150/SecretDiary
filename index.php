			...
			if($_POST['sign'] == '1'){
				...
				if($_POST['password'] != $_POST['password']){
					...
					if(mysqli_num_rows($result) > 0){
						...
						$error = '<p>This email is already registered</p>';
...
<body>
	...
	<div class="container text-center col-md-6" id="header">
		<div id="heading">
		<h1>Secret Diary</h1>
			<p id="thought">Store your thoughts permenantly and securely</p>
		</div>
		...
		<div id="error" >
			...
			<?php 
				if($error != ""){
					echo "<div id='error' class='alert alert-danger' role='alert'>"."There were error(s) in your form:".$error."</div>" ;
				}else if($success !=""){
		...
		<div id="signUp">	
				<p style="color: white;">Intrested ? Please Sign up now</p>
				<form method="post">
				...
				<p></h1><a href="#" class= "toggleForm" id="clickLogIn"> Log in</a></p>
		</div>
		...
		<div id="logIn">	
				...
				<p><a href="#" class= "toggleForm" id="clicksignup"> Sign Up</a></p>
		</div>
		</div>
